...
-- https://tableplus.com/
--
-- Database: appfixceler_mvc_php
-- Generation Time: 2024-06-29 13:44:22.5890
-- -------------------------------------------------------------
...
(1, 'Sincronizacion', 120.00),
(2, 'Cambio de kit reparticion', 80.00),
(3, 'Reparacion de motor', 60.00),
(4, 'Inyeccion Electronica', 80.00),
(5, 'Cambio de Rodamientos', 60.00),
(6, 'Suspension', 60.00),
(7, 'Cambio de aceite', 60.00),
(8, 'Direccion Electroasistida', 300.00),
(9, 'Frenos', 400.00),
(10, 'Pintura', 50.00),
(11, 'latoneria', 150.00);

INSERT INTO `usuarios` (`id`, `nombre`, `apellido`, `email`, `password`, `telefono`, `admin`, `confirmado`, `token`) VALUES
(9, ' Cesar', 'Perez', 'cesarperez@misena.edu.co', '$2y$10$9TTiKdZXQaUQaSbVKd7wPOucLusU8ebkv2h2IgqNjQXs.uLTW7CAq', '1234567890', 0, 1, '');
